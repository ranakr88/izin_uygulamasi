...
<div class="mb-3">
    ...
    <input type="text" name="tc_no" class="form-control" maxlength="11" placeholder="11 haneli TC No" required>
         ...
         <option value="İzmir">Hatay</option>
         <option value="İzmir">Eskişehir</option>
        </select>
      </div>
                    ...
                    <thead>
                        ...
                        <tbody>
                            <?php if(!empty($izinler)): ?>
                                ...
                                <tr>
                                    <td class="ps-3"><?= $izin->baslangic_tarihi ?> / <?= $izin->bitis_tarihi ?></td>
                                    <td><?= $izin->sebep ?></td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="3" class="text-center py-3">Henüz bir izin talebiniz bulunmuyor.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
